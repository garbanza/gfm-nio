...
public interface TimbradoSoap {
    ...
    /**
     * Servicio de aceptación-rechazo de peticiones de cancelación para emisores.
     * 
     * @param usuarioIntegrador
     * @param folioUUID
     * @param rfcEmisor
    ...
    @RequestWrapper(localName = "ConsultaCfdisRelacionadosEmisor", targetNamespace = "http://tempuri.org/", className = "pac1.prod.ConsultaCfdisRelacionadosEmisor")
    @ResponseWrapper(localName = "ConsultaCfdisRelacionadosEmisorResponse", targetNamespace = "http://tempuri.org/", className = "pac1.prod.ConsultaCfdisRelacionadosEmisorResponse")
