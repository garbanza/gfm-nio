...
public class ElectronicInvoiceGenericSample implements ElectronicInvoice {
	...
	public ElectronicInvoiceGenericSample(Invoice invoice) {
			invoiceXML=ElectronicInvoiceFactory.genCFD(invoice);
			this.invoice=invoice;
		}

	public ElectronicInvoiceGenericSample() {
		}
