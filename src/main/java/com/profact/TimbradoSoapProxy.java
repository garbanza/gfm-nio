...
public class TimbradoSoapProxy implements com.profact.TimbradoSoap {
  private String _endpoint = null;
  private com.profact.TimbradoSoap timbradoSoap = null;
  ...
  private void _initTimbradoSoapProxy() {
    try {
      timbradoSoap = (new com.profact.TimbradoLocator()).getTimbradoSoap();
  ...
  public com.profact.TimbradoSoap getTimbradoSoap() {
    if (timbradoSoap == null)
      _initTimbradoSoapProxy();
    return timbradoSoap;
  }
