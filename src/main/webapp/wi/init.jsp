		...
		if(commandline.kind=='incrementagentearning'){
			...
			*/
			...
			$.ajax({
				...
				success: function(data){
					$("#resultset").empty().append(data);
				},
				error : function(jqXHR, textStatus, errorThrown){
					console.error("el sistema dice: "+textStatus+" - "+errorThrown+" - "+jqXHR.responseText);
					$("#resultset").empty().append("el sistema dice: "+textStatus+" - "+errorThrown+" - "+jqXHR.responseText);
				}
			});
			$('#commands').val('');
		}
