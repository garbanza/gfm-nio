...
public class TimbradoLocator extends org.apache.axis.client.Service implements test.profact.Timbrado {
    ...
    private java.lang.String TimbradoSoap_address = "http://www.timbracfdipruebas.mx/serviciointegracionpruebas/Timbrado.asmx";
    ...
    public test.profact.TimbradoSoap getTimbradoSoap() throws javax.xml.rpc.ServiceException {
    ...
    public test.profact.TimbradoSoap getTimbradoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.profact.TimbradoSoapStub _stub = new test.profact.TimbradoSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.profact.TimbradoSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.profact.TimbradoSoapStub _stub = new test.profact.TimbradoSoapStub(new java.net.URL(TimbradoSoap_address), this);
                _stub.setPortName(getTimbradoSoapWSDDServiceName());
                return _stub;
            }
        }
