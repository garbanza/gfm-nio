...
<xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;</xsl:text>
   ...
   <body>
	...
	<tr>
		...
		<span class="bold">Emisor</span>: RFC <xsl:value-of select="cfdi:Emisor/@rfc"/>, <xsl:value-of select="cfdi:Emisor/@nombre"/>,
		<xsl:apply-templates select="//cfdi:DomicilioFiscal"/><br/>
		<xsl:value-of select="$INVOICE_SENDER_ADDITIONAL_DATA"/><br/>
		<span class="bold">Receptor</span>: RFC <xsl:value-of select="cfdi:Receptor/@rfc"/>, <xsl:value-of select="cfdi:Receptor/@nombre"/>,
