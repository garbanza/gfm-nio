...
<xsl:text disable-output-escaping='yes'>&lt;!DOCTYPE html&gt;</xsl:text>
   ...
   <body>
	...
	<tr>
		...
		Uso CFDI <xsl:apply-templates select="cfdi:Receptor/@UsoCFDI"/>
		</td>
		<td class="emitData">
		...
		<xsl:choose>
			<xsl:when test="@MetodoPago">
				<span class="bold">Método de pago</span>: <xsl:value-of select="@MetodoPago"/><br/>
			</xsl:when>
		</xsl:choose>
		<xsl:choose>
			<xsl:when test="@FormaPago">
				<span class="bold">Forma de pago</span>: <xsl:value-of select="@FormaPago"/><br/>
			</xsl:when>
      </xsl:choose>
			<!--span class="bold">Método de pago</span>: <xsl:value-of select="@MetodoPago"/><br/>
			<span class="bold">Forma de pago</span>: <xsl:value-of select="@FormaPago"/><br/-->
